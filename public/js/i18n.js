...
(function () {
  ...
  const DICT = {
    zh: {
      ...
      'tut.step1.title': '前往网站进行签名（推荐使用「易签」）',
      'tut.step1.desc': '在手机浏览器中打开下方签名网站，按网站提示完成签名操作：',
      'tut.step1.link': '打开签名网站：https://www.xiaobai51.top/#home',
    ...
    en: {
      ...
      'brand.name': 'Ranmoku',
      'brand.sub': 'Original iOS Wallpapers',
      ...
      'tut.step1.title': 'Sign in on the signing site (we recommend “易签”)',
      'tut.step1.desc': 'Open the signing site below in your mobile browser and follow its instructions:',
      'tut.step1.link': 'Open signing site: https://www.xiaobai51.top/#home',
